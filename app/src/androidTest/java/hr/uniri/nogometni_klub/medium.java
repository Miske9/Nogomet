...
public class medium {
    ...
    public void testPlayerList() {
        ...
        Espresso.onView(ViewMatchers.withId(R.id.editGodine))
                .perform(ViewActions.replaceText("25"));
        Espresso.onView(ViewMatchers.withId(R.id.editPozicija))
                .perform(ViewActions.replaceText("Napadac"));

        Espresso.onView(ViewMatchers.withId(R.id.btnSpremi))
